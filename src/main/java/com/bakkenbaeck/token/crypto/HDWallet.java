...
public class HDWallet {
    ...
    private void initWordList() {
        try {
            InputStream targetStream = this.getClass().getResourceAsStream("bip39_wordlist.txt");
            MnemonicCode.INSTANCE = new MnemonicCode(targetStream, null);
    ...
    private HDWallet initWallet(String seed) {
        this.masterSeed = seed;//null;// readMasterSeedFromStorage();
